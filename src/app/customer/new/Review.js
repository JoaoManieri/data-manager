        ...
        <Grid item xs={12}>
          <Typography variant="body1">
            <TextField
              ...
              variant="standard"
              fullWidth
              defaultValue={dataCliente.fantasia}
            />
          </Typography>
        </Grid>
        ...
        <Grid item xs={6}>
          <Typography variant="body1">
            <TextField
              ...
              variant="standard"
              fullWidth
              defaultValue={dataCliente.atividadePrincipal}
            />
          </Typography>
        </Grid>
        <Grid item xs={6}>
        ...
        <Grid item xs={12}>
          <Typography variant="body1">
            <TextField
              ...
              fullWidth
              variant="standard"
              defaultValue={dataCliente.fatorCompetitivo}
            />
          </Typography>
        </Grid>
      </Grid>
